...
const PALADIN_FIGHTING_STYLES: FightingStyle[] = [
  ...
  { id: 'protection', name: 'Protección', text: 'Cuando una criatura que puedes ver ataca a un objetivo a 5 pies o menos de ti, puedes usar tu reacción para imponer desventaja a la tirada de ataque. Debes empuñar un escudo.' },
  {
  ...
  { id: 'interception', name: 'Intercepción', source: 'TCE', text: 'Cuando una criatura que puedes ver acierta a un objetivo a 5 pies de ti, puedes usar tu reacción para reducir el daño en 1d10 + tu bonificador de competencia. Debes empuñar un escudo o un arma.' },
]
...
const DEVOTION: Subclass = {
  ...
  features: [
    { level: 3, subclass: 'devotion', name: 'Canalizar Divinidad: Arma Sagrada', text: 'Como acción, imbuyes un arma que empuñas con energía positiva durante 1 minuto. Añades tu modificador de Carisma a las tiradas de ataque con ella (mínimo +1). El arma emite luz brillante en 20 pies y luz tenue 20 pies más. Si el arma no era mágica, lo es mientras dure. Termina si sueltas el arma o si usas esta opción otra vez.' },
    { level: 3, subclass: 'devotion', name: 'Canalizar Divinidad: Expulsar a los Impíos', text: 'Como acción, presentas tu símbolo sagrado y cada fiend o no-muerto a 30 pies que pueda verte u oírte hace una salvación de Sabiduría. Si falla, queda expulsado 1 minuto o hasta recibir daño.' },
    ...
    { level: 20, subclass: 'devotion', name: 'Nimbo Sagrado', text: 'Como acción, emanas luz solar durante 1 minuto: luz brillante en 30 pies. Los enemigos que empiecen su turno dentro reciben 10 de daño radiante, y tienes ventaja en salvaciones contra conjuros de fiends y no-muertos. Una vez por descanso largo.' },
  ],
  resources: [
...
const ANCIENTS: Subclass = {
  ...
  features: [
    { level: 3, subclass: 'ancients', name: 'Canalizar Divinidad: Ira de la Naturaleza', text: 'Como acción, invocas zarcillos espectrales alrededor de una criatura a 10 pies. Debe superar una salvación de Fuerza o Destreza o quedar apresada. Puede repetir la salvación al final de cada uno de sus turnos.' },
    { level: 3, subclass: 'ancients', name: 'Canalizar Divinidad: Expulsar a los Infieles', text: 'Como acción, presentas tu símbolo sagrado y cada fey o fiend a 30 pies que pueda verte u oírte hace una salvación de Sabiduría o queda expulsado 1 minuto.' },
...
const VENGEANCE: Subclass = {
  ...
  features: [
    { level: 3, subclass: 'vengeance', name: 'Canalizar Divinidad: Abjurar Enemigo', text: 'Como acción, eliges una criatura a 60 pies que puedas ver. Hace una salvación de Sabiduría o queda asustada 1 minuto (velocidad 0). Si la supera, su velocidad se reduce a la mitad 1 minuto.' },
    { level: 3, subclass: 'vengeance', name: 'Canalizar Divinidad: Voto de Enemistad', text: 'Como acción adicional, eliges una criatura a 10 pies. Ganas ventaja en tiradas de ataque contra ella durante 1 minuto o hasta que caiga a 0 puntos de golpe.' },
    ...
    { level: 15, subclass: 'vengeance', name: 'Alma de Venganza', text: 'Cuando una criatura bajo tu Voto de Enemistad ataca, puedes usar tu reacción para hacerle un ataque cuerpo a cuerpo.' },
    { level: 20, subclass: 'vengeance', name: 'Ángel Vengador', text: 'Como acción, ganas alas y vuelo 60 pies durante 1 hora. Los enemigos a 30 pies hacen una salvación de Sabiduría o quedan asustados 1 minuto. Una vez por descanso largo.' },
  ],
  resources: [
...
export const PALADIN: CharClass = {
  ...
  features: [
    { level: 1, name: 'Sentido Divino', text: 'Como acción, hasta el final de tu siguiente turno detectas la presencia de celestiales, fiends y no-muertos a 60 pies que no estén tras cobertura total, y percibes lugares u objetos consagrados o profanados. Usos: 1 + tu modificador de Carisma, por descanso largo.' },
    { level: 1, name: 'Imposición de Manos', text: 'Tienes una reserva de curación que se repone en cada descanso largo, igual a 5 × tu nivel de paladín. Como acción, tocas una criatura y gastas puntos de la reserva para restaurarle esa cantidad de puntos de golpe. Alternativamente puedes gastar 5 puntos para curar una enfermedad o neutralizar un veneno.' },
    ...
    { level: 14, name: 'Toque Purificador', text: 'Como acción, terminas un conjuro sobre ti o sobre una criatura voluntaria que toques. Usos: tu modificador de Carisma (mínimo 1), por descanso largo.' },
