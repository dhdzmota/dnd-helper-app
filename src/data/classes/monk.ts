...
const OPEN_HAND: Subclass = {
  ...
  features: [
    ...
    { level: 6, subclass: 'open-hand', name: 'Plenitud Corporal', text: 'Como acción, recuperas puntos de golpe iguales al triple de tu nivel de monje. Una vez por descanso largo.' },
    ...
    { level: 17, subclass: 'open-hand', name: 'Palma Temblorosa', text: 'Cuando aciertas con un ataque sin armas, gastas 3 puntos de ki para poner vibraciones letales en el cuerpo del objetivo. Duran tus días de nivel de monje. Con una acción puedes acabarlas: si falla una salvación de Constitución, cae a 0 puntos de golpe; si la supera, recibe 10d10 de daño necrótico.' },
  ],
}
...
const SHADOW: Subclass = {
  ...
  features: [
    ...
    { level: 6, subclass: 'shadow', name: 'Paso de Sombra', text: 'Cuando estás en luz tenue u oscuridad, como acción adicional te teletransportas hasta 60 pies a otro espacio en luz tenue u oscuridad. Ganas ventaja en el primer ataque cuerpo a cuerpo antes del final del turno.' },
    { level: 11, subclass: 'shadow', name: 'Manto de Sombras', text: 'En luz tenue u oscuridad, con una acción te vuelves invisible. Dura hasta que ataques, lances un conjuro o entres en luz brillante.' },
    { level: 17, subclass: 'shadow', name: 'Oportunista', text: 'Cuando una criatura a 5 pies de ti recibe daño de otra criatura, puedes usar tu reacción para hacerle un ataque cuerpo a cuerpo.' },
  ],
}
...
const ELEMENTAL_DISCIPLINES: ChoiceGroup = {
  ...
  options: [
    { id: 'elemental-attunement', name: 'Sintonía Elemental', text: 'Sin coste. Con una acción creas un efecto elemental inofensivo: una llama en la palma, una brisa, un puñado de agua o de tierra.' },
    { id: 'shape-flowing-river', name: 'Moldear el Río Fluyente', text: 'Sin coste. Con una acción, congelas o descongelas agua o hielo en un área de 30 pies de lado a 120 pies.' },
    ...
    { id: 'water-whip', name: 'Látigo de Agua', text: '2 puntos de ki. Como acción adicional, una criatura a 30 pies hace una salvación de Destreza: 3d10 contundente y la derribas o la atraes 25 pies. Mitad de daño si la supera.' },
...
export const MONK: CharClass = {
  ...
  features: ([
    ...
    { level: 1, name: 'Artes Marciales', text: 'Con ataques sin armas y armas de monje puedes usar Destreza en vez de Fuerza, tiras el dado de artes marciales en vez del daño normal, y cuando atacas con una de ellas puedes hacer un ataque sin armas como acción adicional.' },
    ...
    { level: 3, name: 'Ataque Alimentado por Ki', source: 'TCE', text: 'Si gastas 1 punto de ki o más como parte de tu acción en tu turno, puedes hacer un ataque sin armas como acción adicional.' },
    { level: 4, name: 'Curación Acelerada', source: 'TCE', text: 'Como acción adicional, gastas 2 puntos de ki y recuperas puntos de golpe iguales a una tirada de tu dado de artes marciales más tu bonificador de competencia.' },
    ...
    { level: 3, name: 'Desviar Proyectiles', text: 'Cuando te acierta un ataque a distancia con arma, usas tu reacción para reducir el daño en 1d10 + tu modificador de Destreza + tu nivel de monje. Si lo reduces a 0, puedes atrapar el proyectil y gastar 1 punto de ki para lanzarlo de vuelta con alcance 20/60.' },
    { level: 4, name: 'Caída Lenta', text: 'Cuando caes, usas tu reacción para reducir el daño de la caída en cinco veces tu nivel de monje.' },
    ...
    { level: 7, name: 'Quietud de la Mente', text: 'Con una acción puedes terminar un efecto que te tenga encantado o asustado.' },
