...
export const GLORY: Subclass = {
  ...
  features: [
    { level: 3, subclass: 'glory', source: 'TCE', name: 'Canalizar Divinidad: Atleta sin Par', text: 'Como acción adicional, durante 10 minutos tienes ventaja en las pruebas de Atletismo y Acrobacias, tu capacidad de carga se dobla y la distancia que saltas aumenta en 10 pies.' },
    { level: 3, subclass: 'glory', source: 'TCE', name: 'Canalizar Divinidad: Castigo Inspirador', text: 'Justo después de usar Castigo Divino, como acción adicional repartes puntos de golpe temporales entre las criaturas que elijas a 30 pies, incluido tú. El total es 2d8 + tu nivel de paladín.' },
