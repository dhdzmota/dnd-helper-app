...
const THIEF: Subclass = {
  ...
  features: [
    { level: 3, subclass: 'thief', name: 'Manos Rápidas', turno: 'adicional', text: 'Puedes usar la acción adicional de Acción Astuta para hacer una prueba de Juego de Manos, usar tus herramientas de ladrón para desarmar una trampa o abrir una cerradura, o realizar la acción de Usar un Objeto.' },
...
const ARCANE_TRICKSTER: Subclass = {
  ...
  features: [
    ...
    { level: 13, subclass: 'arcane-trickster', name: 'Embaucador Versátil', turno: 'adicional', text: 'Como acción adicional, tu Mano de Mago distrae a una criatura a 5 pies de ella: ganas ventaja en tus tiradas de ataque contra esa criatura hasta el final del turno.' },
    { level: 17, subclass: 'arcane-trickster', name: 'Ladrón de Conjuros', turno: 'reaccion', text: 'Cuando una criatura lanza un conjuro que te apunta, usas tu reacción para intentar robarlo. Si falla una salvación con tu CD, el conjuro falla, tú lo aprendes durante 8 horas y ella no puede lanzarlo en ese tiempo. Una vez por descanso largo.' },
  ],
  resources: [
...
export const ROGUE: CharClass = {
  ...
  features: ([
    ...
    { level: 2, name: 'Acción Astuta', turno: 'adicional', text: 'Tu agilidad mental te deja realizar la acción de Correr, Desengancharse o Esconderse como acción adicional en cada uno de tus turnos.' },
    ...
    { level: 3, name: 'Puntería Firme', turno: 'adicional', source: 'TCE', text: 'Como acción adicional, ganas ventaja en tu siguiente tirada de ataque de este turno. Solo puedes usarlo si no te has movido, y tu velocidad pasa a 0 hasta el final del turno.' },
    { level: 5, name: 'Esquiva Asombrosa', turno: 'reaccion', text: 'Cuando un atacante que puedes ver te acierta, usas tu reacción para reducir a la mitad el daño de ese ataque.' },
