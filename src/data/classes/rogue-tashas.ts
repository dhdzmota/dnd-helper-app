...
export const SOULKNIFE: Subclass = {
  ...
  resources: [
    { id: 'psionic-energy',
      alimenta: ['Poder Psiónico', 'Hojas del Alma', 'Desgarrar la Mente'], name: 'Dados de Energía Psiónica', detail: 'Alimentan tus rasgos psiónicos; el tamaño del dado sube con el nivel', recharge: 'long', kind: 'pool', level: 3, source: 'TCE', max: { type: 'proficiency', times: 2 } },
  ...
  features: [
    ...
    { level: 3, subclass: 'soulknife', source: 'TCE', name: 'Cuchillas Psíquicas', turno: 'accion', text: 'Como acción, ataque o acción adicional, manifiestas una hoja de energía psíquica: sutil y arrojadiza con alcance 60/120. Inflige 1d6 de daño psíquico, o 1d4 si es la segunda del turno como acción adicional. Cuenta como arma sutil para el Ataque Furtivo y se desvanece tras el ataque.' },
    { level: 9, subclass: 'soulknife', source: 'TCE', name: 'Hojas del Alma', turno: 'adicional', text: 'Golpes Guiados: si fallas con una cuchilla psíquica, gastas un dado psiónico y lo sumas al ataque. Teletransporte Psíquico: como acción adicional, lanzas una cuchilla, gastas un dado y te teletransportas a diez veces su resultado en pies.' },
    { level: 13, subclass: 'soulknife', source: 'TCE', name: 'Velo Psíquico', turno: 'accion', text: 'Como acción, te vuelves invisible 1 hora, junto con lo que lleves. Termina si atacas, fuerzas una salvación o lo disipas. Una vez por descanso largo, o gastando un dado psiónico.' },
