...
const METAMAGIC: ChoiceGroup = {
  ...
  options: [
    ...
    { id: 'quickened', name: 'Conjuro Acelerado', turno: 'gratis', text: '2 puntos. Un conjuro de 1 acción pasa a lanzarse como acción adicional.' },
...
const DRACONIC: Subclass = {
  ...
  features: [
    ...
    { level: 14, subclass: 'draconic', name: 'Alas de Dragón', turno: 'adicional', text: 'Como acción adicional, te brotan alas y ganas velocidad de vuelo igual a tu velocidad actual. Duran hasta que las disipes con otra acción adicional. No funcionan con armadura que no esté adaptada.' },
...
const WILD_MAGIC: Subclass = {
  ...
  features: [
    ...
    { level: 6, subclass: 'wild-magic', name: 'Torcer la Suerte', turno: 'reaccion', text: 'Cuando otra criatura que puedas ver hace una tirada de ataque, prueba o salvación, gastas 2 puntos de hechicería como reacción para sumar o restar 1d4 al resultado.' },
...
export const SORCERER: CharClass = {
  ...
  features: ([
    ...
    { level: 2, name: 'Fuente de Magia', turno: 'adicional', text: 'Tienes puntos de hechicería iguales a tu nivel de hechicero, que se reponen en cada descanso largo. Como acción adicional puedes cambiar puntos por un espacio de conjuro, o gastar un espacio para recuperar puntos iguales a su nivel.' },
