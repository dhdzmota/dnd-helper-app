...
export const ABERRANT_MIND: Subclass = {
  ...
  features: [
    ...
    { level: 1, subclass: 'aberrant-mind', source: 'TCE', name: 'Habla Telepática', turno: 'adicional', text: 'Como acción adicional, abres un vínculo telepático con una criatura a 30 pies que puedas ver. Dura tu modificador de Carisma en minutos, funciona a 1 milla y se comunica en un idioma que ambos conozcáis.' },
...
export const CLOCKWORK_SOUL: Subclass = {
  ...
  features: [
    ...
    { level: 1, subclass: 'clockwork-soul', source: 'TCE', name: 'Restaurar el Equilibrio', turno: 'reaccion', text: 'Cuando una criatura a 60 pies vaya a tirar con ventaja o con desventaja, usas tu reacción para anularla: tira normal. Usos: tu bonificador de competencia, por descanso largo.' },
    { level: 6, subclass: 'clockwork-soul', source: 'TCE', name: 'Bastión de la Ley', turno: 'accion', text: 'Como acción, gastas de 1 a 5 puntos de hechicería para proteger a una criatura a 30 pies con una salvaguarda de tantos d8 como puntos gastaste. Cuando reciba daño, puede gastar dados de la reserva para reducirlo.' },
    { level: 14, subclass: 'clockwork-soul', source: 'TCE', name: 'Trance del Orden', turno: 'adicional', text: 'Como acción adicional, durante 1 minuto los ataques contra ti no pueden tener ventaja, y tratas cualquier d20 de 9 o menos como un 10 en tiradas de ataque, pruebas y salvaciones. Una vez por descanso largo, o gastando 5 puntos de hechicería.' },
    { level: 18, subclass: 'clockwork-soul', source: 'TCE', name: 'Cabalgata de Relojería', turno: 'accion', text: 'Como acción, espíritus llenan un cubo de 30 pies: reparten 100 puntos de golpe entre las criaturas que elijas, terminan todos los conjuros de nivel 6 o inferior sobre ellas, y reparan los objetos dañados. Una vez por descanso largo, o gastando 7 puntos de hechicería.' },
  ],
}
