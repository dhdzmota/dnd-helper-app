...
export const FEATS: Feat[] = [
  { id: 'great-weapon-master', name: 'Maestro de Armas Grandes', en: 'Great Weapon Master',
  ...
  { id: 'polearm-master', name: 'Maestro de Armas de Asta', en: 'Polearm Master',
  ...
  { id: 'sentinel', name: 'Centinela', en: 'Sentinel',
  ...
  { id: 'shield-master', name: 'Maestro del Escudo', en: 'Shield Master', prereq: 'Empuñar un escudo',
  ...
  { id: 'defensive-duelist', name: 'Duelista Defensivo', en: 'Defensive Duelist', prereq: 'Destreza 13 o más',
  ...
  { id: 'telekinetic', name: 'Telequinético', en: 'Telekinetic', source: 'TCE',
  ...
  { id: 'poisoner', name: 'Envenenador', en: 'Poisoner', source: 'TCE',
